                ...
                >
                    <formAdd>
                        <Space style={spaceStyle} direction="vertical" size={20}>
                            <Space>
                                <label><span style={{ color: "blue" }}>*ឈ្មោះ</span>
                                    <Input
                                        value={formAdd.name}
                                        style={inputStyle}
                                        placeholder="ឈ្មោះ"
                                ...
                                <label><span style={{ color: "blue" }}>*IDទំនិញ</span>
                                    <Input
                                        value={formAdd.id}
                                        style={inputStyle}
                                        placeholder="IDទំនិញ"
                            ...
                            <Space>
                                <label><span style={{ color: "blue" }}>*តម្លៃទិញចូលក្នុងមួយដំ </span>
                                    <NumericInputFloat
                                        ...
                                        onChange={e => setFormAdd({ ...formAdd, purchase_price: e.target.value })}
                                        onPressEnter={handleKeyPress}
                                        style={inputStyle}
                                        placeholder="តម្លៃទិញចូលក្នុងមួយដំ"
                                    />
                                </label>
                                <label><span style={{ color: "blue" }}>*តម្លៃលក់ដំ </span>
                                    <NumericInputFloat
                                        value={formAdd.product_price}
                                        onChange={e => setFormAdd({ ...formAdd, product_price: e.target.value })}
                                        onPressEnter={handleKeyPress}
                                        style={inputStyle}
                                        placeholder="តម្លៃលក់ដំ"
                                    />
                                </label>
                                <label><span style={{ color: "blue" }}>*តម្លៃលក់រាយ </span>
                                    <NumericInputFloat
                                        value={formAdd.unit_price}
                                        onChange={e => setFormAdd({ ...formAdd, unit_price: e.target.value })}
                                        onPressEnter={handleKeyPress}
                                        style={inputStyle}
                                        placeholder="តម្លៃលក់រាយ"
                                    />
                                </label>
                                <label><span style={{ color: "blue" }}>*តម្លៃលក់ពិសេស </span>
                                    <NumericInputFloat
                                        value={formAdd.special_price}
                                        onChange={e => setFormAdd({ ...formAdd, special_price: e.target.value })}
                                        onPressEnter={handleKeyPress}
                                        style={inputStyle}
                            ...
                            <label><span style={{ color: "blue" }}>*ចំនួនទិញចូលបន្ថែមដំ </span>
                                <NumericInput
                                    value={formAdd.order_quantity}
                                    onChange={e => setFormAdd({ ...formAdd, order_quantity: e.target.value })}
                                    onPressEnter={handleKeyPress}
                                    style={inputStyle}
                            ...
                            <Space direction='vertical'>
                                <label><span style={{ color: "blue" }}>*ជ្រើសរើសអ្នកនាំចូល </span></label>
                                <Select
